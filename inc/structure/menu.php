<?php
	...
	function render_atg_menu() {
		$output =  '<section id="section-menu"><button class="menu-toggle">Responsive Menu</button><nav><div class="atg-menu"><a href="#section-landing"><span class="menu-icon"></span></a><ul class="nav-menu">';
